...
ifeq ($(config),debug_x32)
  ...
  OBJDIR = ../../../obj/macosx/gmake/x32/Debug/xerceslua
  DEFINES += -D_DEBUG
  INCLUDES += -I../../../deps/LuaBridge -I/usr/local/include/lua
  FORCE_INCLUDE +=
  ...
  LIBS += -llua -lxerces-c
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/local/lib -L../../../bin -m32 -dynamiclib -Wl,-install_name,@rpath/xerceslua.so
...
ifeq ($(config),debug_x64)
  ...
  TARGET = $(TARGETDIR)/xerceslua.so
  OBJDIR = ../../../obj/macosx/gmake/x64/Debug/xerceslua
  DEFINES += -D_DEBUG
  INCLUDES += -I../../../deps/LuaBridge -I/usr/local/include/lua
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  LIBS += -llua -lxerces-c
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/local/lib -L../../../bin -m64 -dynamiclib -Wl,-install_name,@rpath/xerceslua.so
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),debug_native)
  ...
  LIBS += -llua -lxerces-c
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/local/lib -L../../../bin -dynamiclib -Wl,-install_name,@rpath/xerceslua.so
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release_x32)
  ...
  TARGET = $(TARGETDIR)/xerceslua.so
  OBJDIR = ../../../obj/macosx/gmake/x32/Release/xerceslua
  DEFINES +=
  INCLUDES += -I../../../deps/LuaBridge -I/usr/local/include/lua
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_x64)
  ...
  TARGET = $(TARGETDIR)/xerceslua.so
  OBJDIR = ../../../obj/macosx/gmake/x64/Release/xerceslua
  DEFINES +=
  INCLUDES += -I../../../deps/LuaBridge -I/usr/local/include/lua
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
